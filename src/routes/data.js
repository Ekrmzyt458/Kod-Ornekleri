export const videos = [
  {
    id: 1,
    videoName: "Esaretin Bedeli",
    videoImg: "/assets/Esaretin-Bedeli.jpg",
    videoTrailer: "/assets/esaretin.mp4",
    videoView: 450,
    releaseDate: "10 Mart 1995",
    genre: "Dram",
    rating: {
      like: 340,
      dislike: 5
  ...
  {
    id: 2,
    videoName: "Wolf of Wall Street",
    videoImg: "/assets/wows-afiş.jpg",
    videoTrailer: "/assets/WOWS.mp4",
    videoView: 256,
  ...
  },
  {
    id: 3,
    videoName: "Başlangıç",
    videoImg: "/assets/inception-kapak.jpeg",
    videoTrailer: "/assets/inception.mp4",
    videoView: 250,
    releaseDate: "30 Temmuz 2010",
    genre: "Aksiyon",
    rating: {
      like: 200,
      dislike: 15
  ...
  {
    id: 4,
    videoName: "Yüzüklerin Efendisi: Kralın Dönüşü",
    videoImg: "/assets/YüzüklerinEfendisi-3-kapak.jpg",
    videoTrailer: "/assets/Yüzüklerin-3.mp4",
    videoView: 400,
    releaseDate: "19 Aralık 2003",
    genre: "Fantastik",
    rating: {
      like: 200,
      dislike: 15
  ...
  },
  {
    id: 5,
    videoName: "Yeşil Yol",
    videoImg: "/assets/yeşil-yol-afiş.jpg",
    videoTrailer: "/assets/The Green Mile.mp4",
    videoView: 300,
    releaseDate: " 17 Mart 2000",
    genre: "Fantastik",
    rating: {
      like: 200,
      dislike: 15
  ...
  {
    id: 6,
    videoName: "Kara Şövalye",
    videoImg: "/assets/kara.jpg",
    videoTrailer: "/assets/Knight.mp4",
    videoView: 150,
    releaseDate: "25 Temmuz 2008",
    genre: "Aksiyon",
    rating: {
      like: 140,
      dislike: 5
    ...
    info: {
      konu: "The Dark Knight'da, Batman suça karşı savaşını daha da ileriye götürüyor: Teğmen Jim Gordon ve Bölge Savcısı Harvey Dent’in yardımlarıyla, Batman, şehir sokaklarını sarmış olan suç örgütlerinden geriye kalanları temizlemeye girişir. Bu ortaklığın etkili olduğu açıktır, ama ekip kısa süre sonra kendilerini, Joker olarak bilinen ve Gotham şehri sakinlerini daha önce de dehşete boğmuş olan suç dehasının yarattığı karmaşanın ortasında bulurlar.",
      oyuncular: "Maggie Gyllenhaal, Heath Ledger, Christian Bale, 	Cillian Murphy",
      yönetmen: "Cristopher Nolan",
      ülke: "ABD",
  ...
  },
  {
    id: 7,
    videoName: "Prestij",
    videoImg: "/assets/prestij-afiş.webp",
    videoTrailer: "/assets/Prestige.mp4",
    videoView: 156,
    releaseDate: "22 Aralık 2006",
    genre: "Gizem",
    rating: {
      like: 100,
      dislike: 10
  ...
  {
    id: 8,
    videoName: "Forrest Gump",
    videoImg: "/assets/forrest-gump.jpg",
    videoTrailer: "/assets/Forrest-Gump.mp4",
    videoView: 250,
  ...
  {
    id: 9,
    videoName: "Yüzüklerin Efendisi: İki Kule",
    videoImg: "/assets/ikiz-kule.webp",
    videoTrailer: "/assets/lotr-iki-kule.mp4",
    videoView: 400,
  ...
  },
  {
    ...
    videoImg: "/assets/the-godfather.jpg",
    videoTrailer: "/assets/THE GODFATHER.mp4",
    videoView: 600,
    releaseDate: "19 Ekim 1973",
    genre: "Dram",
    rating: {
      like: 500,
      dislike: 15
  ...
  {
    id: 11,
    videoName: "Dövüş Kulübü",
    videoImg: "/assets/Fight-club-afiş.jpg",
    videoTrailer: "/assets/fight.mp4",
    videoView: 400,
    ...
    info: {
      konu: "Uykusuzluk sorunu çeken bir ofis çalışanı ve tasasız bir sabuncu gizli bir dövüş kulübü kurarlar. Bu kulüp, kısa bir süre sonra beklediklerinden çok daha fazlasına dönüşecektir.",
  ...
  {
    id: 12,
    videoName: "V For Vendetta",
    videoImg: "/assets/v-for-vendetta.jpg",
    videoTrailer: "/assets/v-for-vendetta.mp4",
    videoView: 400,
    releaseDate: "31 Mart 2006",
    genre: "Aksiyon",
    rating: {
      like: 200,
      dislike: 15
    ...
    info: {
      konu: "V olarak bilinen maskeli bir adam, geleceğin totaliter rejimle yönetilen İngilteresi'nde korkuyla sindirilmiş halkına egemenliği geri verebilmek için şiddete başvuran biridir. V İngiltere halkını, kendisiyle Guy Fawkes günü olan 5 Kasım’da Parlamento’nun çevresinde buluşmaya davet eder.",
  ...
  },
  {
    id: 13,
    videoName: "Piyanist",
    videoImg: "/assets/piyanist-afiş.jpg",
    videoTrailer: "/assets/piyanist.mp4",
    videoView: 450,
    releaseDate: "28 Şubat 2003",
    genre: "Dram",
    rating: {
      like: 200,
      dislike: 15
    ...
    info: {
      ...
      oyuncular: "Adien Brody, Emilia Fox, Ed Stoppard",
      yönetmen: "Roman Polanski",
      ülke: "Almanya-Polonya-İngiltere-Fransa",
      tarih: "28 Şubat 2003"
    },
    comments: [
      {
  ...
  },
  {
    id: 14,
    videoName: "3 Ahmak",
    videoImg: "/assets/3-ahmak.jpg",
    videoTrailer: "/assets/3 Idiots.mp4",
    videoView: 100,
    releaseDate: "9 Kasım 2009",
    genre: "Komedi",
    rating: {
      like: 50,
      dislike: 15
  ...
  },
  {
    id: 15,
    videoName: "Yedi",
    videoImg: "/assets/seven_kapak.jpg",
    videoTrailer: "/assets/seven.mp4",
    videoView: 230,
    releaseDate: "16 Şubat 1996",
    genre: "Gerilim",
    rating: {
      like: 200,
      dislike: 15
    ...
    info: {
      konu: "Cinayet masasından iki dedektif bir seri katilin peşine düşer. Bu katil, cinayetleri dünyayı yedi ölümcül günahtan temizlemek için işlemektedir. Bu günahları işleyenlerden bir liste yapan katil, kendini tanrının görevlisi sayar ve kurbanlarını acımasızca öldürür.",
  ...
  {
    id: 16,
    videoName: "Yüzüklerin Efendisi",
    videoImg: "/assets/yüzüklerin-1.jpg",
    videoTrailer: "/assets/Yüzüklerin-1.mp4",
    videoView: 330,
    releaseDate: "22 Eylül 2001",
    genre: "Fantastik",
    rating: {
      like: 200,
      dislike: 15
